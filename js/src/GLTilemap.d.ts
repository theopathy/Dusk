...
export declare class GLTilemap {
    ...
    readonly layers: ReadonlyArray<TGLLayer>;
    readonly tilesets: ReadonlyArray<GLTileset>;
    readonly viewportWidth: number;
    readonly viewportHeight: number;
    readonly scaledViewportWidth: number;
    readonly scaledViewportHeight: number;
    repeatTiles: boolean;
    tileScale: number;
